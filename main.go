...
func main() {
	...
	router.HandleFunc("/guests", GetGuests).Methods("GET")
	router.HandleFunc("/guests/{id}", GetGuest).Methods("GET")
	router.HandleFunc("/guests/{id}", CreateGuest).Methods("POST")
	router.HandleFunc("/guests/{id}", DeleteGuest).Methods("DELETE")
